...
echo "Generate Ground Truth Test Output for tRCD"
...
echo "Generate Ground Truth Test Output for Open Page Policy"
...
echo "Generate Ground Truth Test Output for tCCD_L"
...
echo "Generate Ground Truth Test Output for tCCD_S and tRRD_S"
...
echo "Generate Ground Truth Test Output for tCCD_L and tRRD_L"
...
echo "Generate Ground Truth Test Output for Read to Write"
...
echo "Generate Ground Truth Test Output for Write to Read"
...
echo "Generate Ground Truth Test Output for multiple commands received on the same CPU clock cycle"
./../sim.exe test_traces/sameClockCycle_test.txt -o ground_truth/sameClockCycle_test.txt  			

echo "Generate Ground Truth Test Output for consecutive memory accesses to all bank groups and banks"
