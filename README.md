...
| tRRD_L     | Row-to-row delay, for accesses to the SAME bank group                                                                                                                  |                                  |             6 |                    6 |                  12 |
| tRRD_S     | Row-to-row delay, for accesses to the DIFFERENT bank group                                                                                                             |                                  |             4 |                    4 |                   8 |
...
| tRCD       | Minimum time between an ACT command and READ command                                                                                                                   | Row Column Delay (RAS/CAS Delay) |            24 |                   24 |                  48 |
...
| tWTR_L     | Write to Read turn around time, specifies how much time must elapse from the last bit of the write data burst prior to a read command being issued on the same bank    |                                  |            12 |                   12 |                  24 |
| tWTR_S     | Write to Read turn around time, specifies how much time must elapse from the last bit of the write data burst prior to a read command being issued on a different bank |                                  |             4 |                    4 |                   8 |
